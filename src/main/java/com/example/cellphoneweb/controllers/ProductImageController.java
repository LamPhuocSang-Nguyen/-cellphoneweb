...
public class ProductImageController {
    ...
    public ResponseEntity<ApiReponse> getAllImage(@PathVariable Long id) {
    ...
    public ResponseEntity<ApiReponse> upLoads(@PathVariable long id, @ModelAttribute("files") List<MultipartFile> files) throws IOException {
